...
python -c "import os, sys; sys.path.append(os.path.realpath('./pmisc'));import version; print(version.__version__)" > version.txt
...
REM # - py.test --doctest-glob='*.rst' %EXTRA_DIR%\docs
