...
project = u'Pmisc'
copyright = u'2013-2016, Pablo Acosta-Serafini'
...
latex_documents = [
  ('index', 'src.tex', u'src Documentation',
   u'Pablo Acosta-Serafini', 'manual'),
]
...
man_pages = [
    ('index', 'Pmisc library', u'src Documentation',
     [u'Pablo Acosta-Serafini'], 1)
]
...
epub_copyright = u'2013-2016, Pablo Acosta-Serafini'
